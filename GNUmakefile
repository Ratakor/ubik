# TODO DO SH SCRIPTS LIKE FOR PLUTO ZIG KERNEL INSTEAD OF GNUmakefile
# and cache in zig-cache ?
...
$(IMAGE_NAME).hdd: limine kernel
	...
	mcopy -i $(IMAGE_NAME).hdd@@1M zig-out/bin/kernel limine.cfg limine/limine-bios.sys ::/
